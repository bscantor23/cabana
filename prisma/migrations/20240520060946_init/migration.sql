...
-- AddForeignKey
ALTER TABLE "usuario_telefono" ADD CONSTRAINT "usuario_telefono_id_usuario_fkey" 
...
-- AddForeignKey
ALTER TABLE "ciudad" ADD CONSTRAINT "ciudad_id_departamento_fkey" 
...
-- AddForeignKey
ALTER TABLE "centro_poblado" ADD CONSTRAINT "centro_poblado_id_ciudad_fkey" 
...
-- AddForeignKey
ALTER TABLE "alojamiento" ADD CONSTRAINT "alojamiento_id_propietario_fkey" 
FOREIGN KEY ("id_propietario") REFERENCES "usuario"("id_usuario") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "alojamiento" ADD CONSTRAINT "alojamiento_id_tipo_alojamiento_fkey" 
FOREIGN KEY ("id_tipo_alojamiento") REFERENCES "tipo_alojamiento"("id_tipo_alojamiento") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "alojamiento" ADD CONSTRAINT "alojamiento_id_centro_poblado_fkey" 
FOREIGN KEY ("id_centro_poblado") REFERENCES "centro_poblado"("id_centro_poblado") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fotografia_alojamiento" ADD CONSTRAINT "fotografia_alojamiento_id_alojamiento_fkey" 
FOREIGN KEY ("id_alojamiento") REFERENCES "alojamiento"("id_alojamiento") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reserva" ADD CONSTRAINT "reserva_id_alojamiento_fkey" 
FOREIGN KEY ("id_alojamiento") REFERENCES "alojamiento"("id_alojamiento") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reserva" ADD CONSTRAINT "reserva_id_arrendatario_fkey" 
FOREIGN KEY ("id_arrendatario") REFERENCES "usuario"("id_usuario") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pago_reserva" ADD CONSTRAINT "pago_reserva_id_reserva_fkey" 
FOREIGN KEY ("id_reserva") REFERENCES "reserva"("id_reserva") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pago_reserva" ADD CONSTRAINT "pago_reserva_id_tipo_pago_fkey" 
FOREIGN KEY ("id_tipo_pago") REFERENCES "tipo_pago"("id_tipo_pago") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "encuesta_reserva" ADD CONSTRAINT "encuesta_reserva_id_reserva_fkey" 
FOREIGN KEY ("id_reserva") REFERENCES "reserva"("id_reserva") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reserva_detalle" ADD CONSTRAINT "reserva_detalle_id_reserva_fkey" 
FOREIGN KEY ("id_reserva") REFERENCES "reserva"("id_reserva") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reserva_detalle" ADD CONSTRAINT "reserva_detalle_id_temporada_fkey" 
FOREIGN KEY ("id_temporada") REFERENCES "temporada"("id_temporada") ON DELETE SET NULL ON UPDATE CASCADE;
